...
private fun subPhaseNameAr(phase: Int, sub: String): String = when (sub) {
    ...
    "2.1" -> "المرحلة 2 — تقييم العروض وقرار الإحالة"
    "2.2" -> "المرحلة 2 — توقيع العقد مع المورد"
    "3.1" -> "المرحلة 3 — تحضير مستندات الاستيراد"
    "3.2" -> "المرحلة 3 — الموافقات الأولية"
    "3.3" -> "المرحلة 3 — تقديم التصريح الجمركي وطلب الإعفاء العسكري"
    "4.1" -> "المرحلة 4 — القيادة العامة للقوات المسلحة (إعفاء جمركي/عسكري — إلزامي)"
    "4.2" -> "المرحلة 4 — دائرة الجمارك الأردنية (الفحص والتقييم)"
    "4.3" -> "المرحلة 4 — مؤسسة الغذاء والدواء (إذن الاستيراد الدوائي)"
    "4.4" -> "المرحلة 4 — وزارة الصحة (تراخيص صحية — اختياري)"
    "5.1" -> "المرحلة 5 — أمر الإفراج الجمركي النهائي"
    "6.1" -> "المرحلة 6 — النقل الآمن من المنفذ/المطار"
    "6.2" -> "المرحلة 6 — استلام الشحنة في المستودعات الطبية"
    "6.3" -> "المرحلة 6 — محضر الاستلام والفحص النهائي (لجنة الاستلام)"
    "7.1" -> "المرحلة 7 — إغلاق المعاملة والتسوية المالية للمورد"
