...
import com.rms.customs.work.BackgroundSyncScheduler
...
class CustomsApp : Application(), Configuration.Provider {
    ...
    private val backgroundSyncScheduler: BackgroundSyncScheduler by inject()
    ...
    override fun onCreate() {
        ...
        backgroundSyncScheduler.scheduleSync()
    }
}
