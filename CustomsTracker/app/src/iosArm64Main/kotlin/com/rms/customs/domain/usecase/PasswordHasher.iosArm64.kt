...
// Duplicated verbatim in iosSimulatorArm64Main/PasswordHasher.iosSimulatorArm64.kt - the
// commonCrypto cinterop klib is per-target and isn't visible from the shared iosMain source set
// (see the comment on PasswordHasher.ios.kt), so this ~15-line primitive can't be deduplicated
// without cinterop commonization, which didn't work reliably for single-target builds/tests.
